...
export async function POST(req) {
  try {
    const { email, bookType } = await req.json();
    ...
    if (bookType === 'hack') {
      ...
      htmlContent = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #0a0a0a; color: #ffffff; padding: 30px; border-radius: 10px; border: 1px solid #00ff41;">
          ...
          <p>Hello,</p>
          <p>Your payment was successful. Here is your permanent VIP access link to the <strong>Ethical Hacking Blueprint</strong>.</p>
      ...
      htmlContent = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #0a0a0a; color: #ffffff; padding: 30px; border-radius: 10px; border: 1px solid #D4AF37;">
          ...
          <p>Hello,</p>
          <p>Your payment was successful. Here is your permanent VIP access link to the <strong>AI Earning Blueprint</strong>.</p>
          <div style="text-align: center; margin: 30px 0;">
    ...
    return NextResponse.json({ success: true, message: 'Email sent instantly!' });
  } catch (error) {
